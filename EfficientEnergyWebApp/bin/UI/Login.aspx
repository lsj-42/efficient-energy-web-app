    ...
    <table>
        <tr>
            ...
            <td style="width: 244px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="IDC_txtUsername" ErrorMessage="Required Field" ForeColor="#FF3300"></asp:RequiredFieldValidator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 244px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="IDC_txtPassword" ErrorMessage="Required Field" ForeColor="#FF3300"></asp:RequiredFieldValidator>
            </td>
        </tr>
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="IDC_btnSubmit" runat="server" OnClick="IDC_btnSubmit_Click" Text="Submit" />
            </td>
